    ...
    <script>
        ...
        if ($(window).width() <= 900) {  
            ...
            $('.c-header-toggler').click(function(){
                ...
                if(clase == "c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show"){
                    $('#sidebar').removeClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show');
                    $('#sidebar').addClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show c-sidebar-show');

                    $('.c-body').click(function(){
                        $('#sidebar').removeClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show c-sidebar-show');
                        $('#sidebar').addClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show');
                    });

                    $('.c-subheader').click(function(){
                        $('#sidebar').removeClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show c-sidebar-show');
                        $('#sidebar').addClass('c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show');
                    });
                }else if(clase == "c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show c-sidebar-show"){
