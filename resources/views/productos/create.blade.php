                                                    ...
                                                    <div class="col-lg-9 col-md-9  form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 form-group">
                                                                ...
                                                                <select class="mdb-select md-form" searchable="buscar.." name="categoria">
                                                            ...
                                                            <div class="col-lg-4 form-group">
                                                                ...
                                                                <input type="text" name="precio_venta" class="form-control amount {{ $errors->has('precio_venta') ? ' is-invalid' : '' }}" value="{{old('precio_venta')}}" id="currency-field" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$"  data-type="currency" placeholder="$0">
                                                            ...
                                                            <div class="col-lg-4 form-group">
                                                                ...
                                                                <div class="input-group" id="show_hide_password">
                                                                    <input type="number" name="cantidad" class="form-control amount {{ $errors->has('cantidad') ? ' is-invalid' : '' }}" value="{{old('cantidad')}}" placeholder="Cantidad" min="0"> 
